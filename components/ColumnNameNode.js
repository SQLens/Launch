...
const ColumnNameNode = ({ data }) => {
  ...
  return _jsxs('div', {
    className: 'column-name-node',
    children: [
      _jsx(Handle, { type: 'target', position: Position.Left }),
      _jsx(Handle, { type: 'source', position: Position.Right }),
      isEditing
        ? _jsx('input', {
            type: 'text',
            value: editedLabel,
        ...
        ? _jsxs(Box, {
            ...
            children: [
              _jsx(IconButton, {
                ...
                children: _jsx(Check, { fontSize: 'inherit' }),
              }),
              _jsx(IconButton, {
                'aria-label': 'cancel',
                size: 'small',
                onClick: handleEditCancel,
                children: _jsx(ClearIcon, { fontSize: 'inherit' }),
              }),
            ],
          })
        : _jsxs(Box, {
            ...
            children: [
              _jsx(IconButton, {
                ...
                children: _jsx(EditIcon, { fontSize: 'inherit' }),
              }),
              _jsx(DeleteColumnButton, { data: data }),
            ],
          }),
    ],
  });
