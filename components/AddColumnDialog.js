  ...
  return _jsx(React.Fragment, {
    children: _jsxs(Dialog, {
      ...
      children: [
        _jsxs(DialogContent, {
          children: [
            _jsx(DialogTitle, { children: 'Add Column and Data Type' }),
            _jsx(TextField, {
              autoFocus: true,
              required: true,
              margin: 'dense',
        ...
        _jsxs(DialogActions, {
          children: [
            _jsx(Button, { onClick: handleAddColumnClose, children: 'Cancel' }),
            _jsx(Button, { onClick: handleSaveClick, children: 'Save' }),
          ],
        }),
      ],
    }),
