      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Effortlessly manage and visualize relational databases with SQLens. Tackle complex relationships and optimize queries with a clear, graphical schema representation. <br></br>Transform database complexity into clarity.
            </p>
