...
import ColumnNameNode from './ColumnNameNode';
  ...
  useEffect(() => {
    if (tables.length > 0) {
      ...
      const updatedNodes = newNodes.map((newNode) => {
        ...
        return existingNode
          ? Object.assign(Object.assign({}, newNode), {
          ...
          children: _jsxs('defs', {
            children: [
              _jsxs('linearGradient', {
                id: 'edge-gradient',
                children: [
                  _jsx('stop', { offset: '0%', stopColor: '#ae53ba' }),
                  _jsx('stop', { offset: '100%', stopColor: '#2a8af6' }),
                ],
              }),
              _jsx('marker', {
                id: 'edge-circle',
